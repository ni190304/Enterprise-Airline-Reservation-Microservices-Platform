...
public class CabinClassMapper {
    ...
    public static void updateEntity(CabinClassRequest request, CabinClass existing) {
        ...
        if (request.getIsBookable() != null)
            existing.setIsBookable(request.getIsBookable());
        if (request.getTypicalSeatPitch() != null)
            existing.setTypicalSeatPitch(request.getTypicalSeatPitch());
        if (request.getTypicalSeatWidth() != null)
            existing.setTypicalSeatWidth(request.getTypicalSeatWidth());
        if (request.getSeatType() != null)
            existing.setSeatType(request.getSeatType());
    }
