...
public class FareMapper {
        ...
        public static FareResponse toResponse(Fare fare) {
                ...
                return FareResponse.builder()
                                ...
                                .advanceSeatSelection(fare.getSeatBenefits() != null
                                                ...
                                                : false)
                                .guaranteedSeatTogether(fare.getSeatBenefits() != null
                                ...
                                .airportTransfer(fare.getPremiumServiceBenefits() != null
                                                ...
                                                : false)
                                .fareRules(fare.getFareRules() != null ? FareRuleMapper.toResponse(fare.getFareRules())
                                                : null)
                                .baggagePolicy(fare.getBaggagePolicy() != null
                                                ? BaggagePolicyMapper.toResponse(fare.getBaggagePolicy())
                                                : null)
        ...
        public static void updateEntity(FareRequest request, Fare existing) {
                ...
                if (request.getCabinClassId() != null)
                        existing.setCabinClassId(request.getCabinClassId());
                if (request.getBaseFare() != null)
                        existing.setBaseFare(request.getBaseFare());
                if (request.getTaxesAndFees() != null)
                        existing.setTaxesAndFees(request.getTaxesAndFees());
                if (request.getAirlineFees() != null)
                        existing.setAirlineFees(request.getAirlineFees());
                ...
                if (request.getFastTrackSecurity() != null)
                        bb.setFastTrackSecurity(request.getFastTrackSecurity());
                ...
                if (request.getLoungeAccess() != null)
                        psb.setLoungeAccess(request.getLoungeAccess());
                if (request.getAirportTransfer() != null)
                        psb.setAirportTransfer(request.getAirportTransfer());
